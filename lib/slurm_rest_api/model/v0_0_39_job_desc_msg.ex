...
defimpl Poison.Decoder, for: SlurmRestAPI.Model.V0039JobDescMsg do
  import SlurmRestAPI.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:crontab, :struct, SlurmRestAPI.Model.V0039CronEntry, options)
    ...
    |> deserialize(:kill_warning_delay, :struct, SlurmRestAPI.Model.V0039Uint16NoVal, options)
    ...
    |> deserialize(:required_switches, :struct, SlurmRestAPI.Model.V0039Uint32NoVal, options)
  end
end
