...
defmodule SlurmRestAPI.Model.V0038DiagStatistics do
  @moduledoc """
  Slurm statistics
  """
  ...
  @type t :: %__MODULE__{
    ...
    :rpcs_by_message_type => [SlurmRestAPI.Model.V0038DiagRpcm.t] | nil,
    :rpcs_by_user => [SlurmRestAPI.Model.V0038DiagRpcu.t] | nil
  }
end

defimpl Poison.Decoder, for: SlurmRestAPI.Model.V0038DiagStatistics do
  import SlurmRestAPI.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:rpcs_by_message_type, :list, SlurmRestAPI.Model.V0038DiagRpcm, options)
    |> deserialize(:rpcs_by_user, :list, SlurmRestAPI.Model.V0038DiagRpcu, options)
  end
end
