...
defmodule SlurmRestAPI.Model.Dbv0038Diag do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :statistics => SlurmRestAPI.Model.Dbv0038DiagStatistics.t | nil
  }
end

defimpl Poison.Decoder, for: SlurmRestAPI.Model.Dbv0038Diag do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:statistics, :struct, SlurmRestAPI.Model.Dbv0038DiagStatistics, options)
  end
end
