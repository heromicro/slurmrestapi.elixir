...
defmodule SlurmRESTAPI.Model.V0040OpenapiReservationResp do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    :reservations => [SlurmRESTAPI.Model.V0040ReservationInfo.t],
  ...
  def decode(value) do
    value
     |> Deserializer.deserialize(:reservations, :list, SlurmRESTAPI.Model.V0040ReservationInfo)
