...
defmodule SlurmRESTAPI.Model.V0041OpenapiDiagResp do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    :statistics => SlurmRESTAPI.Model.V0041OpenapiDiagRespStatistics.t,
  ...
  def decode(value) do
    value
     |> Deserializer.deserialize(:statistics, :struct, SlurmRESTAPI.Model.V0041OpenapiDiagRespStatistics)
