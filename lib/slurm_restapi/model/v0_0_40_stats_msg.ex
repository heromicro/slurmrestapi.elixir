...
defmodule SlurmRESTAPI.Model.V0040StatsMsg do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :req_time => SlurmRESTAPI.Model.V0040Uint64NoVal.t | nil,
    :req_time_start => SlurmRESTAPI.Model.V0040Uint64NoVal.t | nil,
    ...
    :schedule_exit => SlurmRESTAPI.Model.V0040ScheduleExitFields.t | nil,
    ...
    :job_states_ts => SlurmRESTAPI.Model.V0040Uint64NoVal.t | nil,
    ...
    :bf_when_last_cycle => SlurmRESTAPI.Model.V0040Uint64NoVal.t | nil,
    :bf_active => boolean() | nil,
    :bf_exit => SlurmRESTAPI.Model.V0040BfExitFields.t | nil,
    :rpcs_by_message_type => [SlurmRESTAPI.Model.V0040StatsMsgRpcsByTypeInner.t] | nil,
    :rpcs_by_user => [SlurmRESTAPI.Model.V0040StatsMsgRpcsByUserInner.t] | nil
  }
  ...
  def decode(value) do
    value
     |> Deserializer.deserialize(:req_time, :struct, SlurmRESTAPI.Model.V0040Uint64NoVal)
     |> Deserializer.deserialize(:req_time_start, :struct, SlurmRESTAPI.Model.V0040Uint64NoVal)
     |> Deserializer.deserialize(:schedule_exit, :struct, SlurmRESTAPI.Model.V0040ScheduleExitFields)
     |> Deserializer.deserialize(:job_states_ts, :struct, SlurmRESTAPI.Model.V0040Uint64NoVal)
     |> Deserializer.deserialize(:bf_when_last_cycle, :struct, SlurmRESTAPI.Model.V0040Uint64NoVal)
     |> Deserializer.deserialize(:bf_exit, :struct, SlurmRESTAPI.Model.V0040BfExitFields)
     |> Deserializer.deserialize(:rpcs_by_message_type, :list, SlurmRESTAPI.Model.V0040StatsMsgRpcsByTypeInner)
     |> Deserializer.deserialize(:rpcs_by_user, :list, SlurmRESTAPI.Model.V0040StatsMsgRpcsByUserInner)
  end
end
