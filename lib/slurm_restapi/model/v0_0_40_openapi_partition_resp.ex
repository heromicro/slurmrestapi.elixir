...
defmodule SlurmRESTAPI.Model.V0040OpenapiPartitionResp do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    :partitions => [SlurmRESTAPI.Model.V0040PartitionInfo.t],
  ...
  def decode(value) do
    value
     |> Deserializer.deserialize(:partitions, :list, SlurmRESTAPI.Model.V0040PartitionInfo)
