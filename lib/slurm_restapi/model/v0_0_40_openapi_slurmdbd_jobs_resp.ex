...
defmodule SlurmRESTAPI.Model.V0040OpenapiSlurmdbdJobsResp do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    :jobs => [SlurmRESTAPI.Model.V0040Job.t],
  ...
  def decode(value) do
    value
     |> Deserializer.deserialize(:jobs, :list, SlurmRESTAPI.Model.V0040Job)
