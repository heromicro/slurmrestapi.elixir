...
defmodule SlurmRESTAPI.Model.V0039JobDescMsg do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :crontab => SlurmRESTAPI.Model.V0039CronEntry.t | nil,
    ...
    :kill_warning_delay => SlurmRESTAPI.Model.V0039Uint16NoVal.t | nil,
    ...
    :required_switches => SlurmRESTAPI.Model.V0039Uint32NoVal.t | nil,
  ...
  def decode(value) do
    value
     |> Deserializer.deserialize(:crontab, :struct, SlurmRESTAPI.Model.V0039CronEntry)
     ...
     |> Deserializer.deserialize(:kill_warning_delay, :struct, SlurmRESTAPI.Model.V0039Uint16NoVal)
     ...
     |> Deserializer.deserialize(:required_switches, :struct, SlurmRESTAPI.Model.V0039Uint32NoVal)
  end
end
