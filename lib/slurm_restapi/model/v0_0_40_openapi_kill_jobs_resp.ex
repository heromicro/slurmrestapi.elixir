...
defmodule SlurmRESTAPI.Model.V0040OpenapiKillJobsResp do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    :status => [SlurmRESTAPI.Model.V0040KillJobsRespJob.t],
  ...
  def decode(value) do
    value
     |> Deserializer.deserialize(:status, :list, SlurmRESTAPI.Model.V0040KillJobsRespJob)
