...
defmodule SlurmRESTAPI.Model.V0040OpenapiDiagResp do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    :statistics => SlurmRESTAPI.Model.V0040StatsMsg.t,
  ...
  def decode(value) do
    value
     |> Deserializer.deserialize(:statistics, :struct, SlurmRESTAPI.Model.V0040StatsMsg)
