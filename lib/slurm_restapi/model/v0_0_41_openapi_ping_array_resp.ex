...
defmodule SlurmRESTAPI.Model.V0041OpenapiPingArrayResp do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    :pings => [SlurmRESTAPI.Model.V0041OpenapiPingArrayRespPingsInner.t],
  ...
  def decode(value) do
    value
     |> Deserializer.deserialize(:pings, :list, SlurmRESTAPI.Model.V0041OpenapiPingArrayRespPingsInner)
