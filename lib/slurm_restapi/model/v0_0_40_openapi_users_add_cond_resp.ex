...
defmodule SlurmRESTAPI.Model.V0040OpenapiUsersAddCondResp do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    :association_condition => SlurmRESTAPI.Model.V0040UsersAddCond.t,
    :user => SlurmRESTAPI.Model.V0040UserShort.t,
  ...
  def decode(value) do
    value
     |> Deserializer.deserialize(:association_condition, :struct, SlurmRESTAPI.Model.V0040UsersAddCond)
     |> Deserializer.deserialize(:user, :struct, SlurmRESTAPI.Model.V0040UserShort)
