...
defmodule SlurmRESTAPI.Model.V0040OpenapiPingArrayResp do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    :pings => [SlurmRESTAPI.Model.V0040ControllerPing.t],
  ...
  def decode(value) do
    value
     |> Deserializer.deserialize(:pings, :list, SlurmRESTAPI.Model.V0040ControllerPing)
