...
defmodule SlurmRESTAPI.Model.V0041OpenapiKillJobsResp do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    :status => [SlurmRESTAPI.Model.V0041OpenapiKillJobsRespStatusInner.t],
  ...
  def decode(value) do
    value
     |> Deserializer.deserialize(:status, :list, SlurmRESTAPI.Model.V0041OpenapiKillJobsRespStatusInner)
