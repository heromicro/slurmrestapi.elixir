...
defmodule SlurmRESTAPI.Model.V0041OpenapiSlurmdbdStatsResp do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    :statistics => SlurmRESTAPI.Model.V0041OpenapiSlurmdbdStatsRespStatistics.t,
  ...
  def decode(value) do
    value
     |> Deserializer.deserialize(:statistics, :struct, SlurmRESTAPI.Model.V0041OpenapiSlurmdbdStatsRespStatistics)
